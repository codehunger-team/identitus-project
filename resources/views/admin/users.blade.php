			...
			@endif
 			<td>
				<div class="btn-group">
    				...
    				<a style="margin-left:3px" data-toggle="tooltip" title="Delete User" href="/admin/remove-user/{!! $user->id !!}" onclick="return confirm('Are you sure you want to remove this user from the database ?');" class="btn btn-danger btn-xs">
