...
<form method="POST" enctype="multipart/form-data" action="{{url('admin/add-terms')}}">
    ...
    <div class="col-xs-12 col-md-6">
        ...
        <input type="number" class="form-control firstPayment" name="first_payment" id="firstPayment"
            placeholder="First Payment" {{ $isLease == 'LEASE' ? 'disabled' : '' }}
    ...
    <div class="col-xs-12 col-md-6">
        ...
        <input type="text" {{ $isLease == 'LEASE' ? 'disabled' : '' }} class="form-control periodPayment"
            name="period_payment" id="periodPayments" placeholder="$500" value="{{$contracts->period_payment ?? ''}}">
    </div>
    <div class="col-xs-12 col-md-6">
    ...
    <div class="col-xs-12 col-md-6">
        ...
        <input type="number" class="form-control period" {{ $isLease == 'LEASE' ? 'disabled' : '' }} id="periods"
    ...
    <div class="col-xs-12 col-md-6">
        ...
        <input type="number" class="form-control" {{ $isLease == 'LEASE' ? 'disabled' : '' }} id="optionPurchasePrice"
