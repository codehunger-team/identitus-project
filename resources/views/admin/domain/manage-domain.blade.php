...
<form method="POST" action="{{route('admin.manage.domain.update',$d->domain)}}" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-8 mb-4">
            ...
            <input type="text" name="domain" value="{{ $d->domain }}" class="form-control">
            @error('domain')
        ...
        <div class="col-xs-12 col-md-6">
            ...
            <input type="text" id="datetimepicker" name="reg_date" value="{{ $d->reg_date }}"
        ...
        <div class="col-xs-12 col-md-12">
            ...
            <textarea name="description" id="editor" class="form-control">{{ $d->description }}</textarea>
            <br />
        </div>
