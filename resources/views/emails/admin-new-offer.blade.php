...
You've got a new offer of {{ \App\Options::get_option( 'currency_symbol' ) .  $offer[ 'offer-price' ] }} for domain {{ $domain->domain }} <br />
												...
												<tr>
													<td valign="top" class="textContent">
														...
														<h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
															Offer Value: {{ \App\Options::get_option( 'currency_symbol' ) . $offer['offer-price'] }}
														</h3>
														<h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
