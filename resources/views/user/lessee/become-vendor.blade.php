...
<section class="my-4 pb-2 border-bottom ">
    ...
    <div class="alert alert-danger" role="alert">
        <h5>In order to receive money you must have to connect your stripe account with us.</h5>
    </div>
    <a href="{{route('user.stripe-connect')}}" id="connet_stripe" class="btn btn-primary btn-block text-center">Connect
        Account</a>
</section>
<section>
    <div class="alert alert-danger" role="alert">
