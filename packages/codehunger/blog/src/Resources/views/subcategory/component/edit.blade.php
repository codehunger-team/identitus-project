...
<div class="modal fade" id="knowledgebaseSubCategoryEditModal" tabindex="-1" aria-labelledby="knowledgebaseSubCategoryEditModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="" class="needs-validation" novalidate>
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="knowledgebaseSubCategoryEditModalLabel">
                        Update Blog Sub-Category</h5>
