                    ...
                    <form method="POST" action="{{ route('register') }}" onsubmit="return validate()">
                            ...
                            <div class="col-md-6">
                                <div class="form-label-group mb6">
                                    ...
                                    <input type="text" onKeyPress="if(this.value.length==10) return false;" name="phone"
                                        class="form-control  @error('phone') is-invalid @enderror" autofocus required
                                        value="{{ old('phone') ?? '' }}">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                <div class="form-label-group mb6">
                                    ...
                                    <input type="text" name="company" id="company"
                                        class="form-control @error('company') is-invalid @enderror" autofocus required
                                        value="{{ old('company') ?? '' }}">
                                    @error('company')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-lg-6">
                                <div class="form-label-group mb6">
                                    ...
                                    <input type="text" id="country" name="country"
                                        class="form-control @error('country') is-invalid @enderror" autofocus required
                                        value="{{ old('country') ?? '' }}">
                                    @error('country')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <div class="form-label-group mb6">
                                    ...
                                    <input type="text" id="city" name="city"
                                        class="form-control @error('city') is-invalid @enderror" autofocus required
                                        value="{{ old('city') ?? '' }}">
                                    @error('state')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-lg-6">
                                <div class="form-label-group mb6">
                                    ...
                                    <input type="text" name="street_1" id="stree1"
                                        class="form-control @error('street_1') is-invalid @enderror" required
                                        value="{{ old('street_1') ?? '' }}">
                                    @error('state')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-label-group mb6">
                                    ...
                                    <input type="text" id="street2" name="street_2"
                                        class="form-control @error('street_2') is-invalid @enderror" autofocus
                                        value="{{ old('street_2') ?? '' }}">
                                    @error('street_2')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="password-confirm" type="password" onChange="checkPasswordMatch();"
                            ...
                            <div class="col-md-6 mt-2">
                                <input class="form-check-input" type="checkbox" onclick="readTheAgreement('agreement')"
                                    value="1" id="agreement-checkbox" name="is_agreement" data-bs-toggle="modal"> Please
                                tick to agree our
                            ...
                            <div class="col-md-6 mt-2">
                                <input class="form-check-input" name="is_tos" type="checkbox"
                                    onclick="readTheAgreement('tos')" value="1" id="tos-checkbox"> Please tick
                                to agree our Terms of Service
                            </div>
                            <div class="text-center mb-0 mt-3">
                                <div class="form-text">
                                    <br>
                                    <p><b>Please read!</b> When you click on the button below to register and create a
                                        new account, you are agreeing to our <a style="color:blue"
                                            href="{{ route('membership') }}">Membership Agreement</a> and our <a
                                            style="color:blue" href="{{ route('tos') }}">Terms of Service</a>.
                                        <br>
                                        <br>
                                </div>
                                <div>
