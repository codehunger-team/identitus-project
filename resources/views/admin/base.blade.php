         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li @if(isset($active) AND ($active == 'seller-wise-commission')) class="active" @endif>
                     <a href="/admin/seller-wise-commission"><i class="fa fa-globe"></i> <span>Seller Wise Commission</span></a>
                  </li>
                  <li @if(isset($active) AND ($active == 'add-commission')) class="active" @endif>
                     <a href="/admin/add-commission"><i class="fa fa-globe"></i> <span>Add Commission</span></a>
                  </li>
                  <li @if(isset($active) AND ($active == 'domains')) class="active" @endif>
                  <a href="/admin/domains"><i class="fa fa-globe"></i> <span>Domains</span></a>
                  </li>
                  <li @if(isset($active) AND ($active == 'active-lease')) class="active" @endif>
                  <a href="/admin/active-lease"><i class="fa fa-money" aria-hidden="true"></i> <span>Active Lease</span></a>
                  </li>
                  <li @if(isset($active) AND ($active == 'inactive-lease')) class="active" @endif>
                  <a href="/admin/inactive-lease"><i class="fa fa-ban" aria-hidden="true"></i> <span>Inactive Lease</span></a>
                  </li>
                  <li @if(isset($active) AND ($active == 'categories')) class="active" @endif>
                  <a href="/admin/categories"><i class="fa fa-list" aria-hidden="true"></i> <span>Categories</span></a>
                  </li>
                  <li @if(isset($active) AND ($active == 'period')) class="active" @endif>
                  <a href="/admin/period-types"><i class="fa fa-clock-o" aria-hidden="true"></i> <span>Period Types</span></a>
                  </li>
                  <li @if(isset($active) AND ($active == 'option')) class="active" @endif>
                  <a href="/admin/option-expiration"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> <span>Option Expiration</span></a>
                  </li>
                  <li @if(isset($active) AND ($active == 'grace-period')) class="active" @endif>
                  <a href="/admin/grace-period"><i class="fa fa-calendar" aria-hidden="true"></i><span>Grace Period</span></a>
                  </li>
